...
class Quickcast {
    ...
    static List<Quickcast> quickcastList() {
        def l = [] as List<Quickcast>
        l << new Quickcast(id: 1,
                title: 'Interceptors - Grails 3',
                subtitle: '#1 - Grails Quickcast from OCI',
                durationMinutes: 17,
                durationSeconds: 01,
                releaseYear: 2016,
                // tag::dataServerLink[]
                heroImg: 'http://grailsquickcasts.s3.amazonaws.com/quickcast_interceptor.png',
                // end::dataServerLink[]
                videoUrl: 'http://grailsquickcasts.s3.amazonaws.com/grails_quickcast_1_interceptors.mp4',
        ...
        l << new Quickcast(id: 2,
                title: 'JSON Views - Grails 3 ',
                subtitle: '#2 - Grails Quickcast from OCI',
                videoUrl: 'http://grailsquickcasts.s3.amazonaws.com/grails_quickcast_2_jsonviews.mp4',
                heroImg: 'http://grailsquickcasts.s3.amazonaws.com/quickcast_jsonviews.png',
                durationMinutes: 15,
                durationSeconds: 40,
                releaseYear: 2016,
                description: '''
...
''',
        ...
        l << new Quickcast(id: 3,
                title: 'Multi-Project Builds - Grails 3',
                subtitle: '#3 - Grails Quickcast from OCI',
                heroImg: 'http://grailsquickcasts.s3.amazonaws.com/quickcast_multiprojectbuilds.png',
                videoUrl: 'http://grailsquickcasts.s3.amazonaws.com/grails_quickcast_2_jsonviews.mp4',
                durationMinutes: 14,
                durationSeconds: 28,
                releaseYear: 2016,
...
''',
        ...
        l << new Quickcast(id: 4,
                title: 'Angular Scaffolding - Grails 3',
                subtitle: '#4 - Grails Quickcast from OCI',
                heroImg: 'http://grailsquickcasts.s3.amazonaws.com/quickcast_angularscaffolding.png',
                videoUrl: 'http://grailsquickcasts.s3.amazonaws.com/grails_quickcast_2_jsonviews.mp4',
                durationMinutes: 9,
                durationSeconds: 27,
                releaseYear: 2016,
...
''',
        ...
        l << new Quickcast(id: 5,
                title: 'Retrieving Runtime Config Values - Grails 3',
                subtitle: '#5 - Grails Quickcast from OCI',
                heroImg: 'http://grailsquickcasts.s3.amazonaws.com/quickcast_retrievingruntimeconfigvalues.png',
                videoUrl: 'http://grailsquickcasts.s3.amazonaws.com/grails_quickcast_2_jsonviews.mp4',
                durationMinutes: 17,
                durationSeconds: 51,
                releaseYear: 2016,
...
''',
        ...
        l << new Quickcast(id: 6,
                title: 'Developing Grails Application with IntelliJ IDEA - Grails 3',
                subtitle: '#6 - Grails Quickcast from OCI',
                heroImg: 'http://grailsquickcasts.s3.amazonaws.com/quickcast_developinggrailsappswithintellij.png',
                videoUrl: 'http://grailsquickcasts.s3.amazonaws.com/grails_quickcast_2_jsonviews.mp4',
                durationMinutes: 22,
                durationSeconds: 42,
                releaseYear: 2016,
